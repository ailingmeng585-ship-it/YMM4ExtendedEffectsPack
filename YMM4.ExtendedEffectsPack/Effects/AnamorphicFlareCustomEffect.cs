...
internal sealed class AnamorphicFlareCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public AnamorphicFlareCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("AnamorphicFlare")) {}
