...
internal sealed class CameraShakeZoomCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public CameraShakeZoomCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("CameraShakeZoom")) {}
