...
internal sealed class FilmBurnCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public FilmBurnCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("FilmBurn")) {}
