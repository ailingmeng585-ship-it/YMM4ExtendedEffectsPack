...
internal sealed class FisheyeCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public FisheyeCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("Fisheye")) {}
