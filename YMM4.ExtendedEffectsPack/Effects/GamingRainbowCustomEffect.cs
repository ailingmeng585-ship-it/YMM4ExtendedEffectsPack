...
internal sealed class GamingRainbowCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public GamingRainbowCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("GamingRainbow")) {}
