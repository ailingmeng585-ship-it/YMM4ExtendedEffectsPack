...
internal sealed class GlitchShiftCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public GlitchShiftCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("GlitchShift")) {}
