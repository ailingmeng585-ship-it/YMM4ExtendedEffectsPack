...
internal sealed class GodRaysCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public GodRaysCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("GodRays")) {}
