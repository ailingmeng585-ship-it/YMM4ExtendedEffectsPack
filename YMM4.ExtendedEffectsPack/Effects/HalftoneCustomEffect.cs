...
internal sealed class HalftoneCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public HalftoneCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("Halftone")) {}
