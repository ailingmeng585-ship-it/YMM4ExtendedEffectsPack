...
internal sealed class HeartbeatCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public HeartbeatCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("Heartbeat")) {}
