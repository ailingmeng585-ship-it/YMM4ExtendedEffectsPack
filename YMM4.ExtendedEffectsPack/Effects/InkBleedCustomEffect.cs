...
internal sealed class InkBleedCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public InkBleedCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("InkBleed")) {}
