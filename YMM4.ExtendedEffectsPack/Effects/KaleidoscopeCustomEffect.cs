...
internal sealed class KaleidoscopeCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public KaleidoscopeCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("Kaleidoscope")) {}
