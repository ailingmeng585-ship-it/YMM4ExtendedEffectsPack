...
internal sealed class LivingFlameCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public LivingFlameCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("LivingFlame")) {}
