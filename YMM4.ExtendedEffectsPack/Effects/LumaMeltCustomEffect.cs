...
internal sealed class LumaMeltCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public LumaMeltCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("LumaMelt")) {}
