...
internal sealed class MatrixRainCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public MatrixRainCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("MatrixRain")) {}
