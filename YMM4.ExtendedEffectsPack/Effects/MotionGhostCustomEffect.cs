...
internal sealed class MotionGhostCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public MotionGhostCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("MotionGhost")) {}
