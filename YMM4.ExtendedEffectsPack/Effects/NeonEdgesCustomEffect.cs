...
internal sealed class NeonEdgesCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public NeonEdgesCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("NeonEdges")) {}
