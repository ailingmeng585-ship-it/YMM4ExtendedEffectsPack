...
internal sealed class OldFilmCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public OldFilmCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("OldFilm")) {}
