...
internal sealed class PaperTearCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public PaperTearCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
