...
internal sealed class PixelateCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public PixelateCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("Pixelate")) {}
