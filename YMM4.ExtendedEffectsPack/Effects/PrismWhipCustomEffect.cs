...
internal sealed class PrismWhipCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public PrismWhipCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("PrismWhip")) {}
