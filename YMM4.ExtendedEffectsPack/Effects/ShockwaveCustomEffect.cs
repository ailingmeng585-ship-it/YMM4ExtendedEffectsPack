...
internal sealed class ShockwaveCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public ShockwaveCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
