...
internal sealed class SpeedLinesCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public SpeedLinesCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("SpeedLines")) {}
