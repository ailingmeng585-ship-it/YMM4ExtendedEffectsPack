...
internal sealed class SpotlightCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public SpotlightCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("Spotlight")) {}
