...
internal sealed class TheaterCurtainCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public TheaterCurtainCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("TheaterCurtain")) {}
