...
internal sealed class TimeWarpScanCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public TimeWarpScanCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("TimeWarpScan")) {}
