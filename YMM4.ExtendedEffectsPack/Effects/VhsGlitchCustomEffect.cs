...
internal sealed class VhsGlitchCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public VhsGlitchCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("VhsGlitch")) {}
