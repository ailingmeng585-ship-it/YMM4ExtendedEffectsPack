...
internal sealed class VortexSwirlCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public VortexSwirlCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("VortexSwirl")) {}
