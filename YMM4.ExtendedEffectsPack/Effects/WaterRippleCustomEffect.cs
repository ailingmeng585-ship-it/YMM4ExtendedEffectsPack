...
internal sealed class WaterRippleCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public WaterRippleCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("WaterRipple")) {}
