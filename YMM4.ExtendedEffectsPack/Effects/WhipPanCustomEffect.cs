...
internal sealed class WhipPanCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public WhipPanCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("WhipPan")) {}
