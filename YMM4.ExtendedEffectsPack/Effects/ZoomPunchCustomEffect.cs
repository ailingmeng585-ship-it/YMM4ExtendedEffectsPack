...
internal sealed class ZoomPunchCustomEffect : D2D1CustomShaderEffectBase, IPackShader
{
    public ZoomPunchCustomEffect(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices)) {}
    ...
    {
        PackUniforms _cb;
        public Impl() : base(ShaderResourceUri.Get("ZoomPunch")) {}
